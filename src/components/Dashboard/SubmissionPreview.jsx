...
import { getRightFromLetter } from '../../utils/rights.js';
import TimeAgo from '../LocalizedTimeAgo.jsx';
...
export default function SubmissionPreview({ entry }) {
  return (
      ...
      <section className="row clearfix">
        <div className="col-sm-12">
          <div>
            <strong>Datum: </strong>
            <span>
              {toSloDateString(entry.date + PUBLISH_TIME, true)} (
        ...
        <div className="col-sm-12">
          <p className="lead">
            ...
            <span>
              {toSloDateString(entry.date + DEADLINE_OFFSET, true)} (
