  ...
  render() {
    return (
      <div className="component__agrument-editor">
        <p className="lead">Deadline: 12.12.2012 - imaš še 4 dni!</p>
        <form action="https://httpbin.org/get">
          ...
          <div className="form-group">
            <button className="btn btn-primary">Naloži sliko</button>
          </div>
          <div className="checkbox">
            <label>
              <input type="checkbox" />
              Uporabi posebni embed
            </label>
          </div>
          <div className="form-group">
            <textarea className="form-control" placeholder="Prilepi embed kodo" />
          </div>
          <button type="submit" className="btn btn-default">Oddaj</button>
        </form>
      </div>
    );
  }
